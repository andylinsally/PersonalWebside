<template>
  <header
    class="mobile-header d-flex justify-content-between align-items-center px-4 py-3 bg-white w-100"
  >
    ...
    <transition name="fade">
      <div v-if="isMenuOpen" class="mobile-overlay d-flex flex-column p-4">
        <div class="d-flex justify-content-end mb-5">
          <button
            class="btn btn-link text-white p-0 close-btn"
            @click="toggleMenu"
          >
        ...
        <div
          class="overlay-content flex-grow-1 d-flex flex-column justify-content-center px-4"
        >
          ...
          <ul class="nav flex-column gap-4 fs-3 fw-bold tracking-widest ps-4">
            <li class="nav-item">
              <router-link to="/" class="nav-link px-0" @click="closeMenu"
                >HOME</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/about" class="nav-link px-0" @click="closeMenu"
                >ABOUT</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/works" class="nav-link px-0" @click="closeMenu"
                >WORKS</router-link
              >
            </li>
            <li class="nav-item">
